...
#se caso queira uma especifica, usamos index - [] que inicia sua contagem da posição 0

print(frutas[2])

#um intervalo com [:]

print(frutas[2:4]) #sendo o segundo numero a posição literal
